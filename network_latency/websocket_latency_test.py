...
# WEBSOCKET HANDSHAKE
# ==============================
def measure_ws_handshake(host: str, port: int, ip_address: str, ws_path: str, api_key: str, use_tls: bool = True) -> dict:
    ...
    # TLS handshake (skip for plain ws://)
    if use_tls:
        try:
...
def run_test(args):
    ...
    print(f"  Target: {args.scheme}://{host}:{port}{ws_path}")
